  ...
  return (
    <>
      <Sidebar collapsible="icon">
          ...
          <div className="flex items-center justify-start w-full py-2 px-1">
            ...
            {open && (
              <Link
                ...
                className="hidden md:flex ml-2 items-center gap-2 self-center font-bold text-lg"
              >
                Mindmesh
              </Link>
            )}
        ...
        <SidebarContent className=" !mt-0 dark:bg-background scrollbar">
          <SidebarGroup>
            <SidebarGroupContent>
              <WorkspaceSwitcher />
              <Separator />
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              {isLoading ? (
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild className="cursor-pointer mb-1 p-1">
                    <SidebarMenuButton
                      size="lg"
